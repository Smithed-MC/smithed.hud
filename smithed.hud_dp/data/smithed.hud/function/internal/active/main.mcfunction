...
execute unless score @s smithed.hud.dummy = #gamemode smithed.hud.dummy run function smithed.hud:internal/active/gamemode

execute store result storage smithed.hud:storage temp.pid int 1 run scoreboard players get @s smithed.hud.id
function smithed.hud:internal/active/check with storage smithed.hud:storage temp